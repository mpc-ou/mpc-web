...
function MarkerIcon() {
  return (
    <div className='flex items-center justify-center'>
      <svg fill='none' height='32' viewBox='0 0 24 32' width='24' xmlns='http://www.w3.org/2000/svg'>
        <path
          d='M12 0C5.37 0 0 5.37 0 12c0 9 12 20 12 20s12-11 12-20C24 5.37 18.63 0 12 0zm0 16a4 4 0 110-8 4 4 0 010 8z'
          fill='hsl(var(--primary))'
        />
        <circle cx='12' cy='12' fill='white' r='3' />
      </svg>
    </div>
  );
}
...
export function LocationPicker({ initial, onChange, clearable = true, placeholder = "Chọn địa điểm..." }: Props) {
  ...
  useEffect(() => {
    ...
    setNameVi(newNameVi);
    setNameEn(newNameEn);
  }, [initial?.lat, initial?.lng, initial?.nameVi, initial?.nameEn, initial]);
