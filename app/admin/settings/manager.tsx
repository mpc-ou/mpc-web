...
import { Globe, Palette, Plus, Share2, Shield, Trash2, Upload, Wrench } from "lucide-react";
    ...
    <div className='flex flex-col gap-8'>
      ...
      <section className='rounded-xl border border-border bg-background p-6 shadow-sm'>
        <h2 className='mb-4 flex items-center gap-2 font-semibold text-foreground text-lg'>
          <Palette className='h-5 w-5 text-primary' /> Nhận diện thương hiệu (Branding)
        </h2>
      ...
      <section className='rounded-xl border border-border bg-background p-5 shadow-sm'>
        <h2 className='mb-4 flex items-center gap-2 font-semibold text-foreground text-lg'>
          <Share2 className='h-5 w-5 text-primary' /> Liên kết mạng xã hội (Footer)
        </h2>
      ...
      <section className='rounded-xl border border-border bg-background p-5 shadow-sm'>
        <h2 className='mb-4 flex items-center gap-2 font-semibold text-foreground text-lg'>
          <Globe className='h-5 w-5 text-primary' /> Liên kết ngoài (Footer)
        </h2>
      ...
      <section className='rounded-xl border border-border bg-background p-5 shadow-sm'>
        <h2 className='mb-4 flex items-center gap-2 font-semibold text-foreground text-lg'>
          <Wrench className='h-5 w-5 text-primary' /> Cài đặt chung (Key-Value)
        </h2>
