...
import { POSITION_LABELS, type ClubRoleEntry, type Department } from "./types";
  ...
  return (
    <>
      ...
      <div className="space-y-4 pt-2">
        ...
        {showRoleForm && (
          <form
            className="space-y-3 rounded-lg border border-dashed border-primary/50 bg-primary/5 p-4"
