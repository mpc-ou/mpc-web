  ...
  return (
    <section className='w-full bg-primary py-16'>
      <div className='container mx-auto px-4'>
        <h2 className='mb-10 text-center font-bold text-2xl text-primary-foreground'>{t("title")}</h2>
        <div className='grid grid-cols-2 gap-6 sm:grid-cols-4'>
          {stats.map((stat) => (
            <div className='flex flex-col items-center gap-1 text-center' key={stat.label}>
              <span className='font-black text-4xl text-primary-foreground sm:text-5xl'>{stat.value}</span>
