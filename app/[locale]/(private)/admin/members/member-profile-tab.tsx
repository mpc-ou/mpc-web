    ...
    <div className="space-y-4 pt-2">
      ...
      <div className="space-y-2">
        ...
        {coverUrl ? (
          ...
          <button
            className="flex h-20 w-full cursor-pointer flex-col items-center justify-center gap-1 rounded-lg border-2 border-dashed border-border bg-muted/30 text-muted-foreground hover:border-primary/50 hover:text-foreground disabled:opacity-50"
