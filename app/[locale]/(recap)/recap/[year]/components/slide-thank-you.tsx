    ...
    <div className="relative flex h-full w-full flex-col items-center justify-center overflow-hidden bg-[#0a0a0f] pt-16">
      ...
      >
        ...
        <motion.h2
          ...
          variants={titleLine1}
        >
          {t("recap.thankYou").split("!")[0].replace(/\s+$/, "")}
        </motion.h2>
        <motion.h2
          className="mb-8 font-black text-[clamp(64px,12vw,140px)] text-orange-500 uppercase leading-[0.85] tracking-tight"
          style={{
            textShadow:
              "0 0 40px rgba(249,115,22,0.5), 0 0 80px rgba(249,115,22,0.3)",
          }}
          variants={titleLine2}
        >
          {t("recap.thankYou").includes("!")
            ? `${t("recap.thankYou").split("!")[1].trim()}!`
            : "!"}
        </motion.h2>

        {/* Subtitle */}
        <motion.p
          className="mb-8 max-w-2xl text-[#94a3b8] text-lg leading-relaxed"
          variants={itemVariants}
        >
        ...
        >
          ...
          <span className="flex items-center gap-3">
            ...
            <span className="font-mono text-orange-400/70 text-sm uppercase tracking-[0.15em]">
              MPC · {year}
            </span>
            <Hexagon className="h-4 w-4 text-orange-400/60" />
          </span>
        ...
        {/* CTA */}
        <motion.p
          className="font-bold text-orange-400/80 text-sm uppercase tracking-[0.2em]"
          variants={itemVariants}
        >
          {t("recap.thankYouCTA")}
        </motion.p>
