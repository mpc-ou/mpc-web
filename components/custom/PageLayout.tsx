...
import { getActiveAnnouncement, getFooterData, getHeaderProfile } from "@/app/[locale]/actions";
...
const PageLayout = async ({ children }: { children: ReactNode }) => {
  const [announcementResult, profileResult, footerResult] = await Promise.allSettled([
