  ...
  return (
    <div className="space-y-1.5">
      ...
      {value ? (
        ...
        <button
          className="flex h-24 w-full cursor-pointer flex-col items-center justify-center gap-1 rounded-lg border-2 border-dashed border-border bg-muted/30 text-muted-foreground transition-colors hover:border-primary/50 hover:text-foreground disabled:opacity-50"
          disabled={uploading}
...
export function PhaseInfo({ data, onChange, mode }: Props) {
  ...
  const set = (key: keyof PhaseInfoData, value: any) =>
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground text-sm">
          Nhập thông tin và ảnh bìa cho recap
        </p>
      </div>
      ...
      <div className="space-y-1.5">
        ...
        {data.musicUrl ? (
          ...
          <button
            className="flex h-16 w-full cursor-pointer items-center justify-center gap-2 rounded-lg border-2 border-dashed border-border bg-muted/30 text-muted-foreground transition-colors hover:border-primary/50 disabled:opacity-50"
          ...
          >
            ...
            <span className="text-sm">
              {musicUploading ? "Đang upload..." : "Upload nhạc nền"}
            </span>
          </button>
        )}
        <input
