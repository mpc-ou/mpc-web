...
// biome-ignore lint/complexity/noExcessiveCognitiveComplexity: ActivityForm manages bilingual activity fields
export default function ActivityForm({ activity }: Props) {
  ...
  const setTitle = useCallback(
    ...
    [bi.viewLang, bi.setTitleVi, bi.setTitleEn]
  );
  ...
  const handleTranslate = useCallback(
    ...
    [otherLang, bi.setTitleVi, bi.setTitleEn, bi.setSummaryVi, bi.setSummaryEn]
  );
