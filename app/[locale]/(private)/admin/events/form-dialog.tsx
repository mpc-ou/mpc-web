          ...
          <div className='grid gap-2'>
            ...
            {bannerUrl ? (
              <div className='relative overflow-hidden rounded-lg border border-border'>
                ...
                <img alt='Banner' className='max-h-50 w-full object-cover' src={bannerUrl} />
                <button
              ...
              <button
                className='flex h-30 w-full cursor-pointer flex-col items-center justify-center gap-2 rounded-lg border-2 border-border border-dashed bg-muted/30 text-muted-foreground hover:border-primary/50 hover:text-foreground disabled:opacity-50'
