  ...
  return (
    <div className='flex flex-col bg-background'>
          ...
          <div className='grid items-center gap-12 lg:grid-cols-2 lg:gap-8 xl:gap-16'>
            <div className='flex flex-col justify-center text-center lg:text-left'>
              ...
              <p className='mt-6 text-balance text-lg text-muted-foreground sm:text-xl'>
                ...
                <strong className='text-foreground'> Khoa Công Nghệ Thông Tin - Đại Học Mở TP.HCM</strong>
              </p>
            </div>
      ...
      <section className='py-20 lg:py-32'>
        <div className='container mx-auto px-4'>
          <div className='grid items-center gap-12 lg:grid-cols-2 lg:gap-8 xl:gap-16'>
            <div className='relative order-2 aspect-square w-full overflow-hidden rounded-3xl border border-border shadow-xl md:aspect-4/3 lg:order-1'>
              <Image
                alt='MPC Activities'
            ...
            <div className='order-1 lg:order-2'>
              <h2 className='mb-8 flex items-center gap-3 text-balance font-bold text-3xl sm:text-4xl'>
                <Target className='h-8 w-8 shrink-0 text-primary' /> Mục đích thành lập
              </h2>
              <ul className='space-y-6 text-lg text-muted-foreground'>
                <li className='flex items-start gap-4'>
                  <span className='mt-2 h-2.5 w-2.5 shrink-0 rounded-full bg-primary' />
                  <span>
                    Tổ chức các buổi Hội thảo chia sẻ tri thức nhằm ôn tập kiến thức các môn Lập trình cơ bản cho sinh
                    viên.
                  </span>
                </li>
                <li className='flex items-start gap-4'>
                  <span className='mt-2 h-2.5 w-2.5 shrink-0 rounded-full bg-primary' />
                  <span>
                    Thành lập các nhóm học tập dưới dạng mô hình "Sinh viên là cố vấn học tập", thường xuyên tổ chức các
                    buổi họp nhóm, nhằm giúp đỡ các bạn học chưa tốt theo kịp các môn học.
                  </span>
                </li>
                <li className='flex items-start gap-4'>
                  <span className='mt-2 h-2.5 w-2.5 shrink-0 rounded-full bg-primary' />
                  <span>
                    Tổ chức training cho thành viên về lập trình trên các thiết bị di động, bao gồm lập trình web, web
                    app, lập trình android.
                  </span>
                </li>
                <li className='flex items-start gap-4'>
                  <span className='mt-2 h-2.5 w-2.5 shrink-0 rounded-full bg-primary' />
                  <span>
                    Tổ chức các Cuộc thi học thuật ứng dụng kiến thức chuyên môn, kết hợp các hoạt động ngoại khóa
                    (ROBOCODE, Web Design, Web Contest...).
                  </span>
                </li>
              </ul>
            </div>
      ...
      <section className='py-20 lg:py-32'>
        <div className='container mx-auto px-4'>
          <div className='mb-16 text-center'>
            ...
            <h2 className='mt-4 font-bold text-3xl sm:text-4xl'>Lĩnh vực hoạt động</h2>
            <p className='mx-auto mt-4 max-w-2xl text-muted-foreground'>
              Câu lạc bộ thường xuyên tổ chức các buổi đào tạo chuyên sâu về các công nghệ hiện đại.
            </p>
          </div>
      ...
      <section className='overflow-hidden border-border border-t bg-muted/10 py-20 lg:py-32'>
        <div className='container mx-auto px-4'>
          <div className='mb-12 text-center md:text-left'>
            ...
            <h2 className='mt-4 font-bold text-3xl sm:text-4xl'>Những thành viên nhiều thành tựu nhất</h2>
          </div>
