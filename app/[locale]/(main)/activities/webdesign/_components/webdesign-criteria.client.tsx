      ...
      <div className='grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4'>
        {CRITERIA.map((item, idx) => (
          <ScrollReveal delay={idx * 100} key={item.title} variant='fade-up'>
            <div className='group flex h-full flex-col items-center gap-4 rounded-2xl border border-slate-200/80 bg-white/90 p-6 text-center shadow-slate-200/50 shadow-xl backdrop-blur-xl transition-all duration-300 hover:border-emerald-500/40 hover:bg-white dark:border-white/10 dark:bg-slate-900/30 dark:shadow-none dark:hover:bg-slate-900/50'>
              ...
              <div>
                <h3 className='mb-2 font-black text-base text-foreground uppercase tracking-tight'>
