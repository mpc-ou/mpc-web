    ...
    <Dialog onOpenChange={onOpenChange} open={open}>
      <DialogContent className='max-h-[90vh] max-w-6xl overflow-y-auto'>
        <DialogHeader>
          ...
          <DialogDescription>{isEdit ? "Cập nhật nội dung bài viết." : "Viết bài viết mới."}</DialogDescription>
        </DialogHeader>
        <form className='grid gap-4 py-4' id='post-form' onSubmit={handleSubmit}>
          ...
          <div className='grid gap-2'>
            ...
            <Input defaultValue={post?.summary ?? ""} id='summary' name='summary' />
          </div>
          <div className='grid gap-2'>
