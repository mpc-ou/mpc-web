...
export const SettingsManager = ({ settings }: { settings: Setting[] }) => {
  ...
  return (
    <div className='flex flex-col gap-4'>
      <form className='flex flex-col gap-3 rounded-xl border border-border bg-background p-4' onSubmit={handleUpsert}>
        <h3 className='font-medium text-foreground text-sm'>Thêm / Cập nhật Setting</h3>
