      ...
      <div className='flex items-center justify-end gap-2'>
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent align='end' className='w-44'>
            <DropdownMenuItem onClick={() => toast({ description: "Chức năng đang được tích hợp" })}>
      ...
      <div className='relative min-h-[300px]'>
        ...
        {viewMode === "TABLE" ? (
          ...
          <div className='grid grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4'>
            {recaps.length > 0 ? (
              // biome-ignore lint/complexity/noExcessiveCognitiveComplexity: recap card item layout
              recaps.map((recap) => (
                <div
