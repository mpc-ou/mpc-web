  ...
  return (
    <Dialog onOpenChange={onOpenChange} open={open}>
      <DialogContent className="max-h-[90vh] overflow-y-auto max-w-4xl">
        {project.thumbnail && (
          <div className="-mx-6 -mt-6 mb-5 relative h-48 sm:h-64 w-full overflow-hidden rounded-t-lg border-b shrink-0">
            <Image
              alt={project.title}
        ...
        {project.content && (
          <>
            <Separator />
            <div
              className="prose prose-sm dark:prose-invert max-w-none break-words w-full overflow-hidden whitespace-pre-wrap prose-iframe:w-full prose-iframe:max-w-full prose-iframe:aspect-video prose-iframe:rounded-lg"
