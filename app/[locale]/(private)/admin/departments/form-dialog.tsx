        ...
        <form className='grid gap-4 py-4' id='dept-form' onSubmit={handleSubmit}>
          ...
          <div className='grid grid-cols-2 gap-4'>
            <div className='grid gap-2'>
              ...
              <Input defaultValue={dept?.nameVi} id='nameVi' name='nameVi' placeholder='Ban Lập trình' required />
            </div>
            <div className='grid gap-2'>
              <Label htmlFor='nameEn'>Tên ban (Tiếng Anh)</Label>
              <Input defaultValue={dept?.nameEn ?? ""} id='nameEn' name='nameEn' placeholder='Programming Dept' />
            </div>
          </div>
          ...
          <div className='grid gap-2'>
            ...
            <Input defaultValue={dept?.icon ?? ""} id='icon' name='icon' placeholder='Code, Camera, PenTool...' />
          </div>
          ...
          <div className='grid grid-cols-2 gap-4'>
            ...
            <div className='grid gap-2'>
              ...
              <Input id='descriptionEn' name='descriptionEn' placeholder='The department handles...' />
            </div>
          </div>
