...
type DeptBgImageUploadProps = {
  ...
  processBgImage: (file: File) => void;
};

function DeptBgImageUpload({
  bgImage,
  setBgImage,
  bgImageUploading,
  isDragOver,
...
function buildDeptPayload(params: {
  nameVi: string;
  nameEn?: string;
  slug: string;
  ...
  return {
    ...
    nameEn: params.nameEn || undefined,
    slug: params.slug,
    descriptionVi: params.descriptionVi ?? undefined,
    descriptionEn: params.descriptionEn ?? undefined,
    missionsVi: params.missionsVi,
    missionsEn: params.missionsEn,
    icon: params.icon || undefined,
    bgImage: params.bgImage || undefined,
    linkLabelVi: params.linkLabelVi || undefined,
    linkLabelEn: params.linkLabelEn || undefined,
    hyperlink: params.hyperlink || undefined,
    order: params.order,
    isActive: params.isActive
  };
}

// biome-ignore lint/complexity/noExcessiveCognitiveComplexity: DeptForm manages department fields and bilingual tabs
export default function DeptForm({ dept }: Props) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    setLoading(true);
    const payload = buildDeptPayload({
      nameVi: bi.titleVi,
      nameEn: bi.titleEn,
      slug,
