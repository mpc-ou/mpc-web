  ...
  return (
    <div className='space-y-6'>
      <div>
        ...
        <p className='text-muted-foreground text-sm'>Kiểm tra lại tổng quan trước khi lưu</p>
      </div>
      ...
      <div className='space-y-3 rounded-lg border p-5'>
        ...
        {info.description && <p className='text-muted-foreground text-sm'>{info.description}</p>}
      </div>
      ...
      <div className='rounded-lg border border-primary/20 bg-primary/5 p-4 text-primary text-sm'>
        Nhấn <strong>"Hoàn tất & Lưu"</strong> để hệ thống tổng hợp dữ liệu và lưu recap.
      </div>
    </div>
  );
}
    ...
    <div className='flex items-center gap-3 rounded-lg border p-4'>
      ...
      <div>
        <div className='font-semibold text-lg'>
          {selected} <span className='font-normal text-muted-foreground text-sm'>/ {total}</span>
        </div>
