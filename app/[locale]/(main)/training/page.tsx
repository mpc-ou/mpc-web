...
const PHASES = [
  {
    ...
    subtitle: "Kì 1-2",
    description: "Ôn tập kiến thức cơ bản, hướng dẫn cách giải quyết vấn đề, cấu trúc dữ liệu và giải thuật",
    icon: Code2,
    color: "bg-blue-500"
  },
  {
    ...
    title: "LẬP TRÌNH WEB",
    subtitle: "Kì 3",
    description: "Ôn tập, đào tạo các kiến thức liên quan đến lập trình web, xây dựng website cơ bản đến nâng cao",
    icon: Globe2,
    color: "bg-green-500"
  },
  {
    ...
    title: "LẬP TRÌNH OOP",
    subtitle: "Kì 4",
    description: "Ôn tập, đào tạo các kiến thức liên quan đến lập trình hướng đối tượng, các tính chất và ứng dụng",
    icon: Layers,
    color: "bg-purple-500"
  },
  {
    ...
    subtitle: "Kì 5",
    description: "Thực hành, xây dựng ứng dụng, dự án thực tế, hướng dẫn cách làm việc nhóm, quản lý dự án",
    icon: Rocket,
    color: "bg-orange-500"
  }
];
    ...
    <div className='min-h-screen bg-background pt-10 pb-20 sm:pt-20'>
      <div className='container mx-auto max-w-4xl px-4'>
        ...
        <ScrollReveal className='mb-16 text-center'>
          ...
          <h1 className='mb-4 font-black text-4xl tracking-tight sm:text-5xl'>TRAINING</h1>
        ...
        <div className='relative mx-auto my-10 max-w-3xl'>
          ...
          <div className='space-y-12'>
            {PHASES.map((phase, index) => {
              ...
              return (
                <ScrollReveal delay={index * 150} key={phase.id} variant={isEven ? "fade-right" : "fade-left"}>
                  <div className='group relative flex items-center md:justify-between'>
                    ...
                    >
                      ...
                      <h3 className='mb-2 font-bold text-xl leading-tight'>{phase.title}</h3>
                    ...
                    <div className='flex w-full items-start md:order-2 md:w-auto md:justify-center'>
                      ...
                      <div className='ml-4 flex-1 md:hidden'>
                        ...
                        <p className='text-muted-foreground text-sm md:text-base'>{phase.description}</p>
                      </div>
                    </div>
