...
import { adminUpdateMember } from "@/app/_actions/admin";
...
export function MemberViewDialog({ locale = "vi", open, onOpenChange, member, onEdit, onDelete }: Props) {
          ...
          <div className='space-y-4'>
            ...
            <div className='space-y-3 text-sm'>
              ...
              <div className='grid grid-cols-3 text-muted-foreground'>
                ...
                <span className='col-span-2 font-medium text-foreground'>
                  {formatLocalDate(member.createdAt, locale)}
                </span>
              </div>
            </div>
          </div>
            ...
            {member.clubRoles.length > 0 ? (
              <div className='flex flex-col gap-2'>
                {member.clubRoles.map((role) => (
                  <div className='flex items-start gap-2 rounded-lg border p-3' key={role.id}>
