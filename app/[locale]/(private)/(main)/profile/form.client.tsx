        ...
        <CardContent className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            {formData.coverImage ? (
              ...
              <button
                className="flex h-40 w-full cursor-pointer flex-col items-center justify-center gap-2 rounded-lg border-2 border-dashed border-border bg-muted/30 text-muted-foreground hover:border-primary/50 hover:text-foreground transition-colors disabled:opacity-50"
