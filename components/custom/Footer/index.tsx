...
const Footer = ({ footerData }: Props) => {
  ...
  const fanpage = footerData?.settings.footer_fanpage || "https://www.facebook.com/CLBLapTrinhTrenThietBiDiDong";
  const youtube = footerData?.settings.footer_youtube || "https://youtube.com";
  const github = footerData?.settings.footer_github || "https://github.com/mpc-ou";
        ...
        <div className='grid grid-cols-1 gap-8 md:grid-cols-3'>
          ...
          <div className='flex flex-col gap-4'>
            <div className='flex items-center gap-2'>
              ...
              <span className='font-black text-primary text-xl tracking-tight'>MPC</span>
            </div>
          ...
          <div className='flex flex-col gap-4'>
            ...
            <ul className='flex flex-col gap-2'>
              ...
              <li>
                <Link className='text-muted-foreground text-sm transition-colors hover:text-primary' href='/about'>
                  {t("aboutUs")}
                </Link>
              </li>
              <li>
