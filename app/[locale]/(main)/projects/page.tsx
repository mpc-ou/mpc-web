...
export default async function ProjectsPage({
  ...
  const payload = data?.payload as { total: number; projects: any[]; totalPages: number } | undefined;
    ...
    <div className='min-h-screen bg-background pt-10 pb-20 sm:pt-20'>
      <div className='container mx-auto max-w-6xl px-4'>
        ...
        <div className='mb-16 text-center'>
          ...
          <h1 className='mb-4 font-black text-4xl tracking-tight sm:text-5xl'>Dự án của chúng tôi</h1>
          <p className='mx-auto max-w-2xl text-lg text-muted-foreground'>
            Tuyển tập các sản phẩm, ứng dụng thực tế do chính các thành viên Câu lạc bộ nghiên cứu và phát triển.
          </p>
        </div>
        ...
        {/* Contact Footer */}
        <div className='mt-20 border-border border-t pt-16 text-center'>
          <h2 className='mb-4 font-bold text-3xl text-foreground'>Bạn muốn tham gia dự án cùng chúng tôi?</h2>
          <p className='mx-auto mb-8 max-w-2xl text-lg text-muted-foreground'>
            Chúng tôi luôn chào đón những thành viên đam mê lập trình, thiết kế và sáng tạo. Hãy kết nối để cùng nhau
