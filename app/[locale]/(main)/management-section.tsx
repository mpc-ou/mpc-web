                    ...
                    return (
                      ...
                      >
                        ...
                        <div>
                          ...
                          <p className='mt-0.5 text-muted-foreground text-xs'>{getTopRole(member.clubRoles)}</p>
                          {member.bio && (
                            <p className='mt-1 line-clamp-2 text-muted-foreground text-xs'>{member.bio}</p>
                          )}
                        </div>
