          ...
          <div className='mb-8 flex flex-wrap items-center justify-between gap-4 border-border/60 border-y py-4 text-muted-foreground text-sm'>
            <div className='flex items-center gap-3'>
              {event.creator?.avatar ? (
                ...
                <img
                  alt={getFullName(event.creator.firstName, event.creator.lastName, locale)}
              ...
              <div className='min-w-0'>
                <span className='block font-semibold text-foreground text-sm leading-none'>
                  {getFullName(event.creator?.firstName, event.creator?.lastName, locale)}
                </span>
                {event.creator?.slug && (
                  <Link
                      ...
                      {event.organizers.map((org: any) => (
                        ...
                        >
                          {org.member.avatar ? (
                            ...
                            <img
                              alt={getFullName(org.member.firstName, org.member.lastName, locale)}
                          ...
                          <span>
                            {getFullName(org.member.firstName, org.member.lastName, locale)}
                            {org.role ? ` (${org.role})` : ""}
                          </span>
                        </Link>
                      ))}
