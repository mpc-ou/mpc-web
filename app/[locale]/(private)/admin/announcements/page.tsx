...
export default async function AdminAnnouncementsPage(): Promise<React.ReactNode> {
  ...
  return (
    <div className='flex flex-col gap-6'>
      <div>
        <h1 className='font-bold text-2xl text-foreground'>📢 Quản lý Thông báo</h1>
        <p className='text-muted-foreground text-sm'>Thông báo hiển thị trên Announcement Bar</p>
      </div>
